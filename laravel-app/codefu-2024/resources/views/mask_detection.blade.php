  ...
  <defs>
    ...
    >
      ...
      <feBlend
        mode="normal"
        in="SourceGraphic"
        in2="effect1_dropShadow_100_799"
        result="shape"
      ></feBlend>
    </filter>
  </defs>
...
<div class="flex justify-center items-center mt-4">
    <div class="video-container">
        <video class="w-64 h-[406px] rounded-[18px] border border-[#9e9d9d]" id="video" width="320" height="240" autoplay playsinline></video>
...
<div class="flex justify-center mt-4">
    <button class="border border-[#9e9d9d] p-[20px] rounded-[10px]" id="capture"><svg
        width="42"
        height="38"
        viewBox="0 0 42 38"
        fill="none"
